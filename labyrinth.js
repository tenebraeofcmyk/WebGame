...
const journalread = document.getElementById("journalread");

document.getElementById("journalreadB").addEventListener('click', healerRoomDoor);
document.getElementById("doorThroneB").addEventListener('click', throneRoomDoor);


function healerRoomDoor() {
...
function labyrinthPuzzle2Q() {
    ...
    document.getElementById("submitBtn").onclick = function () {
        ...
        if (userAnswer == correctAnswerlabyrinth2) {
            ...
            document.getElementById("journalread").style.display = "block";
